...
## Recent supply chain attacks (ex: Mini Shai-Hulud worm)

Some worms hide malicious config in pull requests. When a developer opens the repo, VS Code runs the attacker's code — no clicking, no warning.
